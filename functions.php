...
add_action('admin_menu', 'stile_create_menu');

function stile_create_menu() {

	//create new top-level menu
	add_menu_page('Stile Settings', 'Stile', 'administrator', __FILE__, 'stile_settings_page',get_stylesheet_directory_uri('stylesheet_directory')."/img/settings-icon.png");
...
function register_mysettings() {
	...
	register_setting( 'stile-settings-group', 'new_option_name' );
	register_setting( 'stile-settings-group', 'some_other_option' );
	register_setting( 'stile-settings-group', 'option_etc' );
}

function stile_settings_page() {
?>
<div class="wrap">
<h2>Your Plugin Name</h2>

<form method="post" action="">
    <?php settings_fields( 'stile-settings-group' ); ?>
    <?php do_settings( 'stile-settings-group' ); ?>
    <table class="form-table">
        <tr valign="top">
        <th scope="row">New Option Name</th>
        <td><input type="checkbox" name="new_option_name" value="<?php echo get_option('new_option_name'); ?>" /></td>
        </tr>
